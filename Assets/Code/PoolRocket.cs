...
namespace Asteroids
{
    public class PoolRocket
    {
        ...
        public RocketModel _rocketModel;
        ...
        private RocketProvider GetRocket(HashSet<RocketProvider> rockets)
        {
            ...
            if (rocket == null)
            {
                ...
                for (var i = 0; i < _capacityPool; i++)
                {
                    ...
                    var instantiate = _rocketFabrick.CreateBarrel(_rocketModel)._barrelProvider;
            ...
            rocket.UpdatePosition(_rocketModel.startPosition);
            return rocket;
        }
